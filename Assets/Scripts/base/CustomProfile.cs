...
namespace DefaultNamespace
{
    ...
    [CreateAssetMenu(menuName = "CustomProfile", fileName = "NewCustomProfile", order = 1001)]
    public class CustomProfile : ScriptableObject
    {
        [Header("Rendering")]
        ...
        public void Lerp(CustomProfile p1, CustomProfile p2, float t) {
            float t0 = 1f - t;
