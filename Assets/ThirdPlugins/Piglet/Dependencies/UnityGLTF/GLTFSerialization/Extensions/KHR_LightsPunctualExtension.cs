...
namespace Piglet.GLTF.Schema
{
	...
	public class PunctualLight : GLTFChildOfRootProperty
	{
		...
		public static readonly double RANGE_DEFAULT = 100000;
		...
		public PunctualLight(PunctualLight light, GLTFRoot gltfRoot)
		{
			Type = light.Type;
			Color = light.Color;
	...
	public class KHR_LightsPunctualRootExtension : Extension
	{
		...
		public Extension Clone(GLTFRoot root)
		{
			return new KHR_LightsPunctualRootExtension(lights);
		}
	}

	public class KHR_LightsPunctualExtension : Extension
	{
	...
	public class PunctualLightId : GLTFId<PunctualLight>
	{
		...
		public PunctualLightId(PunctualLightId id, GLTFRoot newRoot)
		{
		}
		...
		public override PunctualLight Value
		{
			get
			{
				if (Root.Extensions.TryGetValue(KHR_lights_punctualExtensionFactory.EXTENSION_NAME, out Extension iextension))
				{
	...
	public class KHR_LightsPunctualNodeExtension : Extension
	{
